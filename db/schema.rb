...
ActiveRecord::Schema[7.0].define(version: 2023_11_13_121558) do
  ...
  create_table "organizations_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organization_id"], name: "index_organizations_tags_on_organization_id"
    t.index ["tag_id"], name: "index_organizations_tags_on_tag_id"
  end
